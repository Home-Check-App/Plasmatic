...
function GamepadIcon(props: SvgProps) {
  return (
    <Svg viewBox="0 0 512 512" {...props}>
      ...
      <Path d="M159.7 132.6c-6.8 0-12.3 5.5-12.3 12.3V167h-22.1c-6.8 0-12.3 5.5-12.3 12.3s5.5 12.3 12.3 12.3h22.1v22.1c0 6.8 5.5 12.3 12.3 12.3s12.3-5.5 12.3-12.3v-22.1h22.1c6.8 0 12.3-5.5 12.3-12.3s-5.5-12.3-12.3-12.3H172v-22.1c0-6.8-5.5-12.3-12.3-12.3z" />
